...
const Content = ({ header, image, isAfterContent, id, hasBackground = false, audioSrc }: ContentProps) => (
  <WidgetWrapper
    id={id ? id : ''}
    ...
    <div className="flex justify-center">
      {audioSrc ? (
        ...
        <div role="status">
          <svg
            aria-hidden="true"
            className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-primary-500 dark:fill-primary"
            viewBox="0 0 100 101"
            fill="none"

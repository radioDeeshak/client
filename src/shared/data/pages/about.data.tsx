...
export const aboutHero: HeroProps = {
  title: 'About Us',
  subtitle:
    'راديو ديشاك هو الراديو السوداني الأول على الانترنت، يعني بالمهاجر والمغترب السوداني في جميع أنحاء العالم. أغاني وموسيقى سودانية وإقليمية على مدار الساعة طوال أيام الأسبوع.',
  callToAction2: {
    text: 'Contact us',
    href: '/contact',
  },
